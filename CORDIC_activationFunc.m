...
plot(x, cordic_sigmoid, 'g.', 'LineWidth', 1.5); % CORDIC Sigmoid function in green dashed
plot(x, cordic_tanh, 'b.', 'LineWidth', 1.5); % CORDIC Tanh function in blue
plot(x, cordic_relu, 'm.', 'LineWidth', 1.5); % CORDIC ReLU function in magenta dash-dot
xlabel('x');
ylabel('CORDIC value');
